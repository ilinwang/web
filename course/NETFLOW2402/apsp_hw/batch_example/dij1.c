/*
  ...
  to compile:   gcc -o dij1 dij1.c
  to run:       dij1 ./inputs/xxx.sp
...
{
  char input_name[200], alg_name[200]="dijh";
  FILE *input;
  int n,m,n_loop;
  double time=0.;
  ...
  n_loop=9; /* assume # loop=9 */

  /* this is where you should put your main shortest path function */

  time=100.1; /* suppose your shortest path function takes 100.1 units
		 of time */
