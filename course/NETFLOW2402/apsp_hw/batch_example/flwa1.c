/*
  ...
  to compile:   gcc -o flwa1 flwa1.c
  to run:       flwa1 ./inputs/xxx.sp
...
{
  char input_name[200], alg_name[200]="flwa";
  FILE *input;
  int n,m,n_loop;
  double time=0.;
  ...
  n_loop=10; /* assume # loop=9 */

  /* this is where you should put your main shortest path function */

  time=200.1; /* suppose your shortest path function takes 100.1 units
		 of time */
